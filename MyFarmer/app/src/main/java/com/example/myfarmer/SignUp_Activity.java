...
public class SignUp_Activity extends AppCompatActivity {
       ...
       String Url="http://"+ com.example.myfarmer.info.getIpAddress()+"/myfarmer/Signup.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        awesomeValidation.addValidation(this ,R.id.txtemail, Patterns.EMAIL_ADDRESS,R.string.inputemail);
